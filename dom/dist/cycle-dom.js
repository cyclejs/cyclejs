...
function makeDOMDriver(container, options) {
    ...
    function DOMDriver(vnode$, runStreamAdapter) {
        ...
        var rootElement$ = preprocessedVNode$.map(function (vnode) {
            ...
            return vnode.elm;
        }).startWith(rootElement).compose(function (stream) {
            return concat_1.default(stream, xstream_1.default.never());
...
},{"./DOMSource":1,"./VNodeWrapper":6,"./isolateModule":12,"./modules":16,"./transposition":17,"./utils":18,"@cycle/xstream-adapter":19,"snabbdom":59,"xstream/extra/concat":63}],14:[function(require,module,exports){
"use strict";
