...
interface EventFnOptions {
  useCapture: boolean;
}

const defaultEventFnOptions: EventFnOptions = {
  useCapture: false,
};
...
export class DOMSource {
  ...
  events(eventType: string, options: EventFnOptions = defaultEventFnOptions): Observable<Event> {
