...
describe('Custom Elements', function () {
  ...
  it('should dispose vtree$ after the custom element has been destroyed', function () {
    let log = [];
  ...
  it('should not emit events after the custom element has been destroyed', function () {
    let log = [];
