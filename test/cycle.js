...
describe('Cycle', function () {
  describe('circularInject', function () {
    it('should tie MVI so that Model data is seen in Intent', function (done) {
      var fakeModel = Cycle.defineDataFlowNode(['i$'], function () {
        return {m$: Rx.Observable.just(2)};
      });
      var fakeView = Cycle.defineDataFlowNode(['m$'], function (model) {
        return {v$: model.m$.map(function (x) { return x * 3; })};
      });
      var fakeIntent = Cycle.defineDataFlowNode(['v$'], function (view) {
    ...
    it('should tie MVI so that Intent data (DELAYED) is seen in View', function (done) {
      var fakeModel = Cycle.defineDataFlowNode(['i$'], function (intent) {
        return {m$: intent.i$.startWith(2)};
      });
      var fakeView = Cycle.defineDataFlowNode(['m$'], function (model) {
        return {v$: model.m$.map(function (x) { return x * 3; })};
      });
      var fakeIntent = Cycle.defineDataFlowNode(['v$'], function () {
    ...
    it('should accept 4 Data Flow Nodes as inputs', function (done) {
      var node1 = Cycle.defineDataFlowNode(function () {
        return {one$: Rx.Observable.just(2)};
      });
      var node2 = Cycle.defineDataFlowNode(['one$'], function (node1) {
        return {two$: node1.one$.map(function (x) { return x * 3; })};
      });
      var node3 = Cycle.defineDataFlowNode(['two$'], function (node2) {
        return {three$: node2.two$.map(function (x) { return x * 5; })};
      });
      var node4 = Cycle.defineDataFlowNode(['three$'], function (node3) {
    ...
    it('should accept 5 Data Flow Nodes as inputs', function (done) {
      ...
      var node5 = Cycle.defineDataFlowNode(['four$'], function (node4) {
    ...
    it('should accept 6 Data Flow Nodes as inputs', function (done) {
      ...
      var node6 = Cycle.defineDataFlowNode(['five$'], function (node5) {
