...
import {Frame} from './$$TIME_DIRECTORY$$/animation-frames';
import {Comparator, OperatorArgs} from './$$TIME_DIRECTORY$$/types';
import {timeDriver as timeDriverUntyped} from './$$TIME_DIRECTORY$$/time-driver';
import {mockTimeSource as mockTimeSourceUntyped} from './$$TIME_DIRECTORY$$/mock-time-source';
